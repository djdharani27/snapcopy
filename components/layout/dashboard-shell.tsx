          ...
          <div className="flex flex-col gap-6">
                ...
                <div className="min-w-0 flex items-center gap-3">
                  <Link href="/" className="flex items-center gap-3">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="truncate text-xs uppercase tracking-[0.22em] text-[#8b7564]">
                        Print dispatch
                      </p>
                    </div>
                  </Link>
            ...
            {!hideIntro ? (
              <div className="max-w-3xl">
                <h1 className="text-2xl font-semibold tracking-[-0.04em] text-slate-900 sm:text-4xl">
                  {title}
                </h1>
